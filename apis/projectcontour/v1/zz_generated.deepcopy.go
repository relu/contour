...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HTTPInternalRedirectPolicy) DeepCopyInto(out *HTTPInternalRedirectPolicy) {
	*out = *in
	if in.RedirectResponseCodes != nil {
		in, out := &in.RedirectResponseCodes, &out.RedirectResponseCodes
		*out = make([]RedirectResponseCode, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTPInternalRedirectPolicy.
func (in *HTTPInternalRedirectPolicy) DeepCopy() *HTTPInternalRedirectPolicy {
	if in == nil {
		return nil
	}
	out := new(HTTPInternalRedirectPolicy)
	in.DeepCopyInto(out)
	return out
}
...
func (in *LoadBalancerPolicy) DeepCopyInto(out *LoadBalancerPolicy) {
	*out = *in
	...
	if in.ZoneAwareLB != nil {
		in, out := &in.ZoneAwareLB, &out.ZoneAwareLB
		*out = new(ZoneAwareLBPolicy)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ZoneAwareLBPolicy) DeepCopyInto(out *ZoneAwareLBPolicy) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ZoneAwareLBPolicy.
func (in *ZoneAwareLBPolicy) DeepCopy() *ZoneAwareLBPolicy {
	if in == nil {
		return nil
	}
	out := new(ZoneAwareLBPolicy)
